...
contract ProposalManager is AccessControl, IProposalManager {
    ITawfPassport public tawfPassport;
    ...
    function createProposal(
        ...
        require(tawfPassport.getPassportType(organizer) == PassportType.Organization, "Organizer must have Organization passport");
    ...
    function setTawfPassport(address _tawfPassport) external onlyRole(ADMIN_ROLE) {
        require(_tawfPassport != address(0), "Invalid passport address");
        tawfPassport = ITawfPassport(_tawfPassport);
    }
